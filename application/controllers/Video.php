...
class Video extends CI_Controller {
	...
	public function detail(){
		...
		if(!$row) redirect('au');
            ...
            $this->load->view('parts/wrapper',array('content'=>'main/video_detail','video_category'=> $this->loadVideoCategory(),'video_type'=>$this->loadVideoType(),'hls'=>$hls,'link'=>$link,'thumbnail'=>$thumbnail,'data'=>$row,'badge'=>$badge));
		} 
	}
